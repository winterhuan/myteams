...
**差异**：Multica 中心是 **Issue 生命周期**；myteams 若只做 Thread A2A 会缺「活从哪来」。可考虑 **Thread + 可选 WorkItem** 双轨。
